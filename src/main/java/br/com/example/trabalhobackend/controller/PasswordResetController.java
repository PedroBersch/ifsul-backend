...
public class PasswordResetController {
    ...
    public ResponseEntity<?> forgotPassword(@RequestBody ForgetPasswordRequest email) {
        ...
        if (user == null) {
            return ResponseEntity.badRequest().body(new MessageResponseDto("Usuario não encontrado"));
        }
        ...
        return ResponseEntity.ok(new MessageResponseDto("Email enviado para recuperar senha."));
    }
    @SecurityRequirements(value = {})
    ...
    public ResponseEntity<?> resetPassword(@RequestBody ResetPasswordRequest resetPasswordRequest) {
        ...
        if (user == null) {
            return ResponseEntity.badRequest().body(new MessageResponseDto("Token Invalido"));
        }
